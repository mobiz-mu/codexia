...
import { computeComplianceStatus, isAlarmStatus, COMPLIANCE_STATUS_SORT_ORDER } from "@/lib/compliance/status";
...
// ---------------------------------------------------------------------------
// Daily alert cron — the actual business logic, kept separate from the
// route handler (which only does the CRON_SECRET check) so it can be unit
// tested directly without faking HTTP requests.
// ---------------------------------------------------------------------------
