  ...
  return (
    <form action={formAction} className="flex w-full max-w-sm flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={pending}
        className="rounded-full bg-action px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:-translate-y-0.5 hover:bg-action-dark hover:shadow-md disabled:pointer-events-none disabled:opacity-60"
      >
