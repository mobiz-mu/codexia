...
import {
  ...
  getComplianceAttachmentSignedUrl,
...
export function ComplianceAttachmentsPanel({
  recordId,
  attachments,
}: {
  recordId: string;
  ...
  function handleUpload(formData: FormData) {
    ...
    startTransition(async () => {
      const result = await uploadComplianceAttachment(recordId, formData);
  ...
  function handleView(storagePath: string) {
    setError(null);
    startTransition(async () => {
      const url = await getComplianceAttachmentSignedUrl(storagePath);
  ...
  function handleDelete(attachmentId: string) {
    ...
    setError(null);
    startTransition(async () => {
      const result = await deleteComplianceAttachment(attachmentId);
